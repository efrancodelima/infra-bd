...
import_resource "aws_route_table_association" "tf_rt_assoc_1" "${ROUTE_TABLE_ID}/${PUBLIC_SUBNET_ID_0}"
import_resource "aws_route_table_association" "tf_rt_assoc_2" "${ROUTE_TABLE_ID}/${PUBLIC_SUBNET_ID_1}"
